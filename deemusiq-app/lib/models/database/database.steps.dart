...
// Hand-patched after generation (redo both steps whenever `make-migrations`
// regenerates this file): (1) these three imports bring ThemeMode/Market and
// the database enums into scope for serialized defaults; (2) defaults naming
// enums that no longer exist in the app (SourceQualities, AudioSource,
// SourceCodecs, SourceType) are folded to their string literals, e.g.
// Constant(SourceQualities.high.name) becomes Constant("high").
...
final class Schema11 extends i0.VersionedSchema {
  ...
  late final Shape16 pluginsTable = Shape16(
      ...
      alias: null);
  late final Shape19 favoritesTable = Shape19(
      source: i0.VersionedTable(
        entityName: 'favorites_table',
        withoutRowId: false,
        isStrict: false,
        tableConstraints: [],
        columns: [
...
class Shape19 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get trackId =>
      columnsByName['track_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get trackName =>
      columnsByName['track_name']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get artistName =>
      columnsByName['artist_name']! as i1.GeneratedColumn<String>;
  ...
  i1.GeneratedColumn<String> get sourceUri =>
      columnsByName['source_uri']! as i1.GeneratedColumn<String>;
...
i1.GeneratedColumn<String> _column_78(String aliasedName) =>
    i1.GeneratedColumn<String>('track_name', aliasedName, false,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<String> _column_79(String aliasedName) =>
    i1.GeneratedColumn<String>('artist_name', aliasedName, false,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<String> _column_80(String aliasedName) =>
    i1.GeneratedColumn<String>('album_name', aliasedName, true,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<String> _column_81(String aliasedName) =>
    i1.GeneratedColumn<String>('thumbnail_url', aliasedName, true,
        type: i1.DriftSqlType.string);
i1.GeneratedColumn<String> _column_82(String aliasedName) =>
    i1.GeneratedColumn<String>('source_uri', aliasedName, true,
        type: i1.DriftSqlType.string);
